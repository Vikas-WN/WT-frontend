    ...
    <ComboboxPrimitive.Portal container={container ?? undefined}>
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          data-chips={!!anchor}
          className={cn("group/combobox-content relative z-[200] max-h-60 w-(--anchor-width) min-w-(--anchor-width) origin-(--transform-origin) overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl shadow-slate-200/50 duration-100 dark:border-wt-border-md dark:bg-wt-surface-1 dark:shadow-none data-[chips=true]:min-w-(--anchor-width) data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 *:data-[slot=input-group]:m-1 *:data-[slot=input-group]:mb-0 *:data-[slot=input-group]:h-8 *:data-[slot=input-group]:border-input/30 *:data-[slot=input-group]:bg-input/30 *:data-[slot=input-group]:shadow-none data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95", className )}
          {...props}
        />
      </ComboboxPrimitive.Positioner>
  ...
  function ComboboxList({ className, ...props }, ref) {
    return (
      <ComboboxPrimitive.List
        ...
        className={cn(
          "wt-combobox-scroll max-h-[min(calc(--spacing(72)---spacing(9)),calc(var(--available-height)---spacing(9)))] scroll-py-1 overflow-y-auto overscroll-contain p-1.5 data-empty:p-0",
          className
        )}
        {...props}
      />
